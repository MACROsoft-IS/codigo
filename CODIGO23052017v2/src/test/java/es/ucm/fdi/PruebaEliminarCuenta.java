...
public class PruebaEliminarCuenta extends TestCase {
	...
	public void testCuentaEliminada(){
		...
		TOSesionImp usuario = as.iniciarSesion("borrar@ucm.es", "contrasena1");
		...
		assertTrue("La cuenta todavia existe \n" + ASGestionCuentaImp.bdCadenas, as.iniciarSesion("borrar@ucm.es", "contrasena1") == null);
		assertFalse("Las otras cuentas no existen \n" + ASGestionCuentaImp.bdCadenas, as.iniciarSesion("conocido1@ucm.es", "contrasena2") == null);
