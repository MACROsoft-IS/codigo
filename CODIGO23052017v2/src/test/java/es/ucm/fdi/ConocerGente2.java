...
public class ConocerGente2 extends TestCase {
	...
	public void TestConocerGente(){
		...
		as.crearCuenta("conocedor", "conocedor@ucm.es", "contrasena1");
		as.crearCuenta("conocido1", "conocido1@ucm.es", "contrasena1");
		as.crearCuenta("desconocido1", "desconocido1@ucm.es", "contrasena1");
		as.crearCuenta("desconocido2", "desconocido2@ucm.es", "contrasena1");
		as.crearCuenta("pendiente1", "pendiente1@ucm.es", "contrasena1");
		as.crearCuenta("pendiente2", "pendiente2@ucm.es", "contrasena1");
		
		
		
		
		TOSesionImp usuario = as.iniciarSesion("conocido1@ucm.es", "contrasena1");
		...
		as.conocerGente(usuario.getCuentaActiva());
