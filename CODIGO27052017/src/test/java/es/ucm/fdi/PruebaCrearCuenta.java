...
public class PruebaCrearCuenta extends TestCase {
	...
	public void testCampoVacio() {
		...
		assertFalse("Se ha creado la cuenta sin el nombre \n" + ASGestionCuentasImp.bdUsers, as.crearCuenta(null, "correo1@ucm.es", "contrasena1","foto","description"));
		
		assertFalse("Se ha creado la cuenta sin el correo \n" + ASGestionCuentasImp.bdUsers, as.crearCuenta("nombre1", null, "contrasena1","foto","description"));
		
		assertFalse("Se ha creado la cuenta sin la contraseña \n" + ASGestionCuentasImp.bdUsers, as.crearCuenta("nombre1", "correo1@ucm.es",null,"foto","description"));
		
		assertFalse("Se ha creado la cuenta sin la contraseña \n" + ASGestionCuentasImp.bdUsers, as.crearCuenta("nombre1", "correo1@ucm.es","contrasena1",null,"description"));
		
		assertFalse("Se ha creado la cuenta sin la contraseña \n" + ASGestionCuentasImp.bdUsers, as.crearCuenta("nombre1", "correo1@ucm.es","contrasena1","foto",null));
	}
	...
	public void testCorreoRepetido() {
		...
		assertFalse("Se ha creado una cuenta con correo repetido \n" + ASGestionCuentasImp.bdUsers, as.crearCuenta("nombre2", "correo1@ucm.es", "contrasena1",null,null));
	...
	public void testNombreRepetido() {
		...
		assertTrue("Se ha creado una cuenta sin nombre repetido \n" + ASGestionCuentasImp.bdUsers, as.crearCuenta("nombre1", "correo2@ucm.es", "contrasena1","foto","description"));
