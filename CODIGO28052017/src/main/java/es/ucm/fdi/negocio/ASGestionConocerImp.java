...
public class ASGestionConocerImp implements ASGestionConocer{
	...
	private int opcion(Scanner in) {
		try{
			...
			Vista.notificar("Opción no válida.\n");
		...
		while (opcion != 4){ ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			if (opcion != 4){
				...
				if (listaConocidos.size() < correos.size()){
					...
					Vista.notificar("Has conocido a toda la gente. Pronto habrá más personas a las que conocer");
	...
	public int muestraPendiente (TOUsuario usuario, String correoAlt, Scanner in){
		
		TOUsuario usuarioAlt = usuarioDAO.read(correoAlt);
		String correoUsuario = usuario.getCorreo();
		
		Vista.notificar(usuarioAlt.toString());
		...
		Vista.notificar("Se ha añadido a " + usuarioAlt.getNombre() + " a la lista de chat.\n");
		...
		Vista.notificar("Se ha bloqueado al usuario " + usuarioAlt.getNombre() + ".\n");
		//System.out.println("Se ha bloqueado al usuario " + usuarioAlt.getNombre() + ".\n");
			break;
		// SALIR
		case 4: 
		Vista.notificar("Ha salido de Conocer Gente.\n");
	...
	public int muestra (TOUsuario usuario, String correoAlt, Scanner in){
	...
	public static void bloquearUsuario (TOUsuario usuario, TOUsuario usuarioABloquear) {
