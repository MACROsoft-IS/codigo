...
public class PruebaEliminarCuenta extends TestCase {
	...
	public void testCuentaEliminada(){
		...
		as.crearCuenta("borrar", "borrar@ucm.es", "contrasena1",null,null);
		as.crearCuenta("conocido1", "conocido1@ucm.es", "contrasena2",null,null);
		as.crearCuenta("conocido2", "conocido2@ucm.es", "contrasena2",null,null);
		as.crearCuenta("pendiente1", "pendiente1@ucm.es", "contrasena2",null,null);
		as.crearCuenta("pendiente2", "pendiente2@ucm.es", "contrasena2",null,null);
		as.crearCuenta("pendiente3", "pendiente3@ucm.es", "contrasena2",null,null);
		as.crearCuenta("pendiente4", "pendiente4@ucm.es", "contrasena2",null,null);
