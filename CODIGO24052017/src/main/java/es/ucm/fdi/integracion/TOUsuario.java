...
import es.ucm.fdi.negocio.Chat;
...
public class TOUsuario implements Serializable { 
	...
	public TOUsuario(String nombre, String correo, String contrasena) {
		...
		this.listaPendientes = new ArrayList<es.ucm.fdi.negocio.Pendiente>();//lista de usuarios pendientes (estructura de correousuario, enum (MANDO, RECIBO)) 
