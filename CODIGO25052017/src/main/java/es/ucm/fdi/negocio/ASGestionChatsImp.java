...
public class ASGestionChatsImp implements ASGestionChats {
	...
	private void mostrarChats(ArrayList<TOChat> listaChats){
	...
	private void salaChat(TOUsuario usuario, TOUsuario usuarioAlt){
	...
	private void abrirChat(TOChat chatA, TOChat chatB, TOUsuario usuario){
